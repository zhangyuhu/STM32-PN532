...
*/
/**************************************************************************/
pn532_error_t pn532_bus_BuildFrame(uint8_t * pbtFrame, size_t * pszFrame, const uint8_t * pbtData, const size_t szData)
{
...
pn532_error_t pn532_bus_SendCommand(const uint8_t * pbtData, const size_t szData)
{
  ...
  delayMs(10);   // FIXME: How long should we wait for ACK?
  ...
  const uint8_t abtAck[6] = { 0x00, 0x00, 0xff, 0x00, 0xff, 0x00 };
...
{
  size_t szLen;
  uint8_t abtWakeUp[] = { 0x55,0x55,0x00,0x00,0x00,0x00,0x00,0xff,0x03,0xfd,0xd4,0x14,0x01,0x17,0x00,0x00,0xff,0x03,0xfd,0xd4,0x14,0x01,0x17,0x00 };
